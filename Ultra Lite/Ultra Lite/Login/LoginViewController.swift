...
class LoginViewController: NSViewController, WKUIDelegate, WKNavigationDelegate, NSWindowDelegate {
    ...
    var loginWebView: WKWebView?                        // Login WebView
    var webViewURLObserver: NSKeyValueObservation?      // WebView URL Observer
    ...
    func setWebView(_ newWebView: WKWebView) {
        ...
        newWebView.customUserAgent = Ultra.userAgent
        newWebView.configuration.applicationNameForUserAgent = Ultra.name
        ...
        loginWebView?.customUserAgent = Ultra.userAgent
        loginWebView?.configuration.applicationNameForUserAgent = Ultra.name
